...
if "%__VCVARSALL_TARGET_ARCH%"=="" (
    rem change this path to your vcvars64.bat
...
set dir=%cd%
set project=%~dp0
rem change this to the relative path of lang
set lang_path=%project%..\
...
rem use this if your project uses hot code reloading
rem set includes=%project%code %lang_path%\modules %lang_path%\modules\win32 %lang_path%\modules\hot_reloading
